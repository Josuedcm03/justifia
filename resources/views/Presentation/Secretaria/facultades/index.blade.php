        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white/50 dark:bg-gray-800/50 shadow sm:rounded-lg p-8">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="font-semibold text-lg text-gray-800 dark:text-gray-200 ml-1">{{ __('Gestionar Facultades') }}</h2>
                    <div>
                        <a href="{{ route('secretaria.facultades.create') }}"
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                        <thead>
                            <tr>
                                <th class="px-6 py-3 border-b bg-[#0099a8] dark:bg-[#007e8b] text-left text-xs font-medium text-white uppercase tracking-wider">Nombre de la Facultad</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @empty
                                <tr>
                                    <td colspan="2" class="px-6 py-4 text-center text-gray-600 dark:text-gray-400">No hay facultades.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
