...
<head>
    ...
    <script>
        // Lee el flag desde el atributo data del <html>, sin Blade dentro del script
        const isAuthPage = document.documentElement.dataset.isAuth === '1';
...
<body class="font-sans text-gray-900 antialiased">
    ...
    <div
        class="{{ $isAuthPage
            ? 'relative min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-cover bg-center'
