        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white/50 dark:bg-gray-800/50 shadow sm:rounded-lg p-8">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="font-semibold text-lg text-gray-800 dark:text-gray-200 ml-1">{{ __('Gestionar Tipos de Constancia') }}</h2>
                    <div>
                            ...
                            @forelse($tipos as $tipo)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-200 text-right space-x-2">
                                        ...
                                        <form action="{{ route('secretaria.tipo-constancia.destroy', $tipo) }}" method="POST" class="inline" data-delete-form data-message="¿Eliminar tipo de constancia?">
                                            @csrf
                                            @method('DELETE')
