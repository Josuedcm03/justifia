    ...
    <div class="py-12">
        <div class="max-w-md mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-5">
                <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">El archivo debe tener una columna llamada <strong>nombre</strong>.</p>
                <form method="POST" action="{{ route('secretaria.asignaturas.import.preview') }}" enctype="multipart/form-data" class="space-y-4" data-import-frontera>
                    @csrf
                    <div class= "flex justify-center" x-data="{ fileName: '' }">
                        ...
                        <input id="file" type="file" name="file" accept=".xlsx" class="hidden" x-on:change="fileName = $event.target.files[0]?.name">
                    </div>
