                    ...
                    class="{{
                        ...
                        @if ($solicitud->estado === \App\Enums\EstadoSolicitud::Pendiente)
                            <div class="absolute bottom-2 right-2 opacity-0 group-hover:opacity-100 transition flex items-center gap-1 pointer-events-none">
                                ...
                                <span class="text-sm text-yellow-600 hidden sm:inline">Procesar solicitud</span>
                            </div>
                        ...
                        <div class="absolute bottom-2 right-2 opacity-0 group-hover:opacity-100 transition flex items-center gap-1 pointer-events-none">
                                ...
                                <span class="text-sm text-red-600 hidden sm:inline">Ver detalles</span>
                            </div>
                        @endif
                        ...
                        @if ($solicitud->estado === \App\Enums\EstadoSolicitud::Pendiente)
                        <span class="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded font-semibold">{{ ucfirst($solicitud->estado->value) }}</span>
                        @elseif ($solicitud->estado === \App\Enums\EstadoSolicitud::Aprobada)
