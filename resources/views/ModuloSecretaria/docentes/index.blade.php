            ...
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-8">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">CIF</th>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($docentes as $docente)
                            <tr>
                                <td class="px-6 py-4">{{ $docente->cif }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="2" class="px-6 py-4 text-center text-gray-600 dark:text-gray-400">No hay docentes.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
