                ...
                <form method="POST" action="{{ route('estudiante.solicitudes.update', ['solicitud' => $solicitud, 'estado' => request()->query('estado', 'pendiente')]) }}" enctype="multipart/form-data" class="space-y-4"
                    ...
                    <div>
                        ...
                        <div class="relative" id="asignatura-wrapper">
                            <input id="asignatura_input" type="text" class="w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:text-white focus:ring-[#0099a8] focus:border-[#0099a8] pr-10" placeholder="Escribe para buscar" autocomplete="off" value="{{ $solicitud->asignatura->nombre }}">
                        ...
                        <input type="hidden" id="asignatura_id" name="asignatura_id" value="{{ old('asignatura_id', $solicitud->asignatura_id) }}">
